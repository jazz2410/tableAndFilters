					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Show standard functions",
									"targetURL": "#standardapp-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"standardapp-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=standardapp",
									"url": sap.ui.require.toUrl("standardapp")
								}
							}
						}
					}
